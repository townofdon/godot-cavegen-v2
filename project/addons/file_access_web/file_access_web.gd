...
signal load_completed(status: FileUploadStatus, file_name: String, file_type: String, base64_data: String)
...
func _notify_complete(status: FileUploadStatus, file_name: String, file_type: String, base64_data: String) -> void:
	load_completed.emit(status, file_name, file_type, base64_data)
...
func _notify_error() -> void:
	_notify_complete(FileUploadStatus.Unsupported, "", "", "")
...
func _on_file_loaded(args: Array) -> void:
	...
	_notify_complete(FileUploadStatus.Completed, file_name, file_type, base64_data)
...
func _on_file_error(args: Array) -> void:
	_notify_complete(FileUploadStatus.Error, "", "", "")
	#error.emit()

func _on_file_cancelled(args: Array) -> void:
	_notify_complete(FileUploadStatus.Cancelled, "", "", "")
